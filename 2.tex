...
\item $E$: Die shows $5$
\item Only one of possible outcomes $1,2,3,4,5,6$ is $5$
...
\item Only one of possible outcomes heads,tails is heads
...
\end{itemize}
\end{example}
\item If $E,F$ as above, then $E$ also denoted \alert{not $F$}
