...
\end{definition}
\item Can figure out fair price $F$ by setting expection equal to zero:
\begin{align*}
...
\item Check by calculating expection:
...
\begin{frame}{Street}
\begin{itemize}
\item Can also bet on three numbers, a \alert{street}
