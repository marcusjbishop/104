...
\item Then remaining trials $F$
\item $\ncr{n}{r}$ ways to choose $r$, so $\ncr{n}{r}$ outcomes have
exactly $r$~successes
...
\item Supose Durant awarded three free-throws
\item Calcaulte probability he makes exactly two
