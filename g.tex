...
\begin{parts}
\part How much money will you win if the ball stops
on one of your four chosen numbers?
\begin{solution}
$\$3\cdot\left(\frac{36}{4}-1\right)=\$24$
\end{solution}
\part What is your expectiation on this bet?
\begin{solution}
$24\left(\frac{4}{38}\right)-3\left(\frac{34}{38}\right)
=-\frac{3}{19}\approx -\$0.16$
\end{solution}
\end{parts}

\uplevel{\bf Monty Hall Problem.}
\question Playing the Monty Hall problem, if you choose
one door, but then switch your choice to the remaining
door, then what is the probability that you will win the game?
