...
exactly seven answers on a multiple-choice quiz
...
\question On an American roulette wheel,
what is the probability of winning a
red bet? A {\em red} bed is a bet on any of the red colored spaces
...
\question On an American roulette wheel, what is the payout
on a $\$2$ bet on a street? A {\em street} is a bet
on three numbers lying in a row on the roulette layout.\\
\begin{oneparchoices}
\choice $\$2$
\choice $\$3$
\choice $\$11$
...
\uplevel{Questions~\ref{FirstF}--\ref{LastR}
deal with the game of farkle.
