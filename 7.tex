...
\item $\frac{\text{same county total}}{\text{grand total}}
...
\item $\frac{\text{same county and bachelor's}}{\text{bachelor's}}
...
\begin{itemize}
\item Since first marble was blue, $5$~red and $6$~blue remain
\item Thus probability of red on second draw $\frac{5}{11}$
\end{itemize}
\end{itemize}
\end{frame}

\begin{frame}{Spanish and Physics Example}
\begin{itemize}
...
enrolled in physics, given that that student enroled in Spanish
