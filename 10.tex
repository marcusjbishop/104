...
\end{tabular}
\item Best hand determined by probability of each hand
...
\item Will first calculate probability that player draws particular
\alert{hand}
...
\item If card of suit $\hs$ lying face up on table, affects probability
