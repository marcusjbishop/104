...
Using a Number~2 pencil record your student ID and name
...
\choice $\left(\frac{1}{5}\right)^7$
\choice $1-\left(\frac{4}{5}\right)^3$
...
of an event which cannot occur?\\
\begin{oneparchoices}
\choice $0.0$
\choice $0.1$
\choice $0.25$
...
with a recent survey of 1422~students about the apartments
...
of cards, all shuffled together.}

\question If you receive the cards $6\heartsuit,9\clubsuit$
initially, what is the probability you will bust if you
...
\question If the dealer has the card $A\diamondsuit$
face-up and another card face-down, what is the probability
