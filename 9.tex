...
listed above
\item Continuing gives final list:
\end{itemize}
\[\begin{array}{ccccc}
\left\{1,2\right\}&\left\{1,3\right\}&\left\{1,4\right\}&\left\{1,5\right\}
  &\left\{1,6\right\}\\
...
\item These outcomes not possible in experiment without replacement
\item Excluding $\left(1,1\right),\ldots,\left(6,6\right)$
gives list of permutations of $\left\{1,2,3,4,5,6\right\}$
taken $2$ at a time
\item Note that $\npr{6}{2}=6\cdot 5=30$
\item Outcomes of dice also include include $\left(i,j\right)$ with $i>j$
...
\item Selecting $4$ pizza toppings
from set of $6$ the same as \alert{not}
selecting $2$
