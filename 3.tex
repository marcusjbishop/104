...
\item However, individual questions registered, so class
averages known, average overall score $8/10$
\item Quiz~1 will be \alert{deleted} in Blackboard, but 10~points
added to everyone's quiz total at \alert{end of semester}
\item Please don't send me 215~emails asking what happended
to Quiz~1 in Blackboard
\item Exam on \alert{Wednesday 17 September} not computer scored
\item Exam covers \S1--\S4
