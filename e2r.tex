...
\runningheadrule
\firstpageheader{\bf Math 104}{\bf Exam 2, Red Form}
{\bf 2 March 2015}
...
\begin{solution}
\begin{parts}
\part Can occur in $6$ ways, so $\frac{6}{36}=\frac{1}{6}$ the probability
\part Can occur in $4$ ways, so $\frac{4}{36}=\frac{1}{9}$ the probability
\part Can occur in $18$ ways, so $\frac{18}{36}=\frac{1}{2}$ the probability
\part Can occur in $11$ ways, so $\frac{11}{36}$ the probability
\end{parts}
\end{solution}
