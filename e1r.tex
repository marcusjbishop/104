...
\begin{solution}$\frac{1}{6}$\end{solution}
\part The result is less than $5$
\begin{solution}$\frac{4}{6}=\frac{2}{3}$\end{solution}
\part The result is odd
\begin{solution}$\frac{3}{6}=\frac{1}{2}$\end{solution}
\end{parts}
...
\begin{solution}$1-0.31=0.69$\end{solution}
...
{O+} or {O-}?
\begin{solution}$0.4+0.09=0.49$\end{solution}
\end{parts}
