...
\item $\frac{\mathrm{Number of times}\;E\;\mathrm{occurred}}{\mathrm{Number of trials}}$ also called
...
visits Expedia
\begin{solution}\answer{$23000000/101250000$}\end{solution}
\item Calculate probability that next visitor
visits Priceline 
