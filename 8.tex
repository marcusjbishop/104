...
\item Denote plates from second and third sets by $B$ and $C$
\item $AAABBBBCCCCC$ and $ABABCCBCCACB$ two possible stacking is 
\item Using this notation, question asks for anagrams of $AAABBBBCCCCC$
