...
\columnbreak
\begin{center}\includegraphics[scale=.4]{NewJersy}
\end{center}
\end{multicols}
...
\question[16] Suppose $E=\left\{a,c,d,e,f\right\}$,
$F=\left\{b,c,g,h,i\right\}$, and $G=\left\{a,b,e,h,i\right\}$.
\begin{parts}
\part What is $\left(E\cup G\right)\cap\left(F\cup G\right)$?
...
\end{align*}
\end{solution}
\part What is $\left(E\cap F\right)\cup G$?
\begin{solution}
\begin{align*}
