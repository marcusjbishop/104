...
labeled by one of the numbers $4,5,6$, calculate
...
\begin{parts}
\part The result is $3$
\begin{solution}[.25in]$\frac{1}{6}$\end{solution}
\part The result is greater than $3$
\begin{solution}[.25in]$\frac{1}{2}$\end{solution}
